...
export function RecognitionScreen() {
  ...
  return (
    <View style={styles.root}>
      ...
      <View style={[styles.content, { paddingTop: insets.top + spacing.lg, paddingBottom: insets.bottom + layout.dockClearance + spacing.md }]}>
        ...
        <View style={styles.footer}>
          {phase === 'idle' && (
            <>
              <Text style={styles.subtitle}>Hold your phone near the sound, then tap the orb.</Text>
